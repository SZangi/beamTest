...
// ********************************************************************
//
/// \file GB01/src/MultiXSBiasing.cc
/// \brief Implementation of the MultiXSBiasing class
//
...
MultiXSBiasing::MultiXSBiasing()
  : G4VBiasingOperator("TestManyExponentialTransform")
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void MultiXSBiasing::AddParticle(G4String particleName)
{
  ...
  if ( particle == 0 )
    {
      ...
      G4Exception("MultiXSBiasing::AddParticle(...)",
                  "exGB01.02",
                  JustWarning,
                  ed);
      return;
  ...
  XSBiasing* optr = new XSBiasing(particleName);
...
void MultiXSBiasing::StartTracking( const G4Track* track )
{
  ...
  std::map < const G4ParticleDefinition*, XSBiasing* > :: iterator
